...
begin
   //
   AFileName:='C:\M4 user\Xrf\Data\ELF\20230711_CVD_2546_map\20230711_CVD_2546_60s_20x20pts';
   MeasurementLifeTimePerPoint:=60000; //in ms
   MeasurementRealTimePerPoint:=60000;  //in ms
   X:=114.89; //top left point
   Y:=81.74;  //top left point
   Z:=10.39;
   xySpeed:=10;
   xyAcc:=10;
   zAcc:=10;
   ...
   //
   XSpacing:=0.025;  //in mm
   YSpacing:=0.025;  //in mm
   //
   XOut := 999;
   YOut := 999;
   ZOut := 999;
