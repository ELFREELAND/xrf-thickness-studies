...
//////////////////////////////////////////////////////
//MODIFIED FOR SINGLE POINT MAP
//THIS WILL NOT MAKE A 20X20 MAP
//DON'T COPY IT
//////////////////////////////////////////////////////
...
begin
   //
   AFileName:='C:\M4 user\Xrf\Data\ELF\20230721_CVD_3158_map\20230721_CVD_3158_60s_20x20pts';
   MeasurementLifeTimePerPoint:=60000; //in ms
   MeasurementRealTimePerPoint:=60000;  //in ms
   X:=91.09; //top left point
   Y:=62.7;  //top left point
   Z:=126.60;
   xySpeed:=10;
   xyAcc:=10;
   zAcc:=10;
   ...
   BEGIN
      ...
      BEGIN
         ...
         //move to target position
         //
         //COMMENTED OUT FOR SINGLE POINT MAP
         //MoveStageToXY(X-XSpacing*i,Y-YSpacing*j,xySpeed,xyAcc,True);
         //END;
